...
import asyncio
import pytest
from agents_protocol import MessageBroker, AgentMessage, MessageType, ClusterManager, ClusterNodeInfo
...
async def test_cluster_forwarding_resilience():
    ...
    peer_info = ClusterNodeInfo(
        node_id="node2",
        endpoint="http://invalid.local:9999"
    )
