...
from agents_protocol import MessageBroker, Agent, AgentMessage, MessageType, MessagePriority, LocalChannel
...
async def run_benchmark(num_messages: int = 400):
    ...
    for p in [MessagePriority.LOW, MessagePriority.NORMAL, MessagePriority.HIGH, MessagePriority.CRITICAL]:
    ...
    try:
        ...
        print(f"Benchmark timed out! Received {len(receiver.received_priorities)} messages.")
